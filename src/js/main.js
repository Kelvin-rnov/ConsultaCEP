...
cep.addEventListener("blur",(e) =>
{
    ...
    //`viacep.com.br/ws/01001-000/json/` é uma string
    //para o fetch vamos passar dois parâmetros: 1° URL do serviço, 2° As opções/options
    fetch(`https://viacep.com.br/ws/${search}/json/`, options)
 
    //vamos tratar a resposta no formato JSON que representa uma promisse/promissa
    .then(response =>{
        response.json()
...
//3. Vamos ler cada valor retornado da promisse e popular nos campos do formulário
